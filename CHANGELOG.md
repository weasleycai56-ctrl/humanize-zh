...
The project uses semantic versioning. Until `1.0.0`, minor releases may refine the Skill's output contract; breaking changes will be called out explicitly.
...
- `audit`, `light`, and `strong` workflows.
- `casual`, `professional`, `academic`, `social`, and `marketing` profiles.
- Fourteen Chinese-first style-signal categories with diagnostic boundaries.
...
[Unreleased]: https://github.com/weasleycai56-ctrl/humanize-zh/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/weasleycai56-ctrl/humanize-zh/releases/tag/v0.1.0
